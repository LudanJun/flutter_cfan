...
class _CfanPageState extends State<CfanPage>
          ...
          child: Builder(
            builder: (context) {
              ...
              return CustomScrollView(
                ...
                key: PageStorageKey<String>(value['name']),
                slivers: [
                  ...
                  SliverPadding(
                    ...
                    sliver: SliverList.builder(
                      itemCount: _cfanUserpostsItemModelList.length,
                      itemBuilder: (context, index) {
                        // return ListTile(
                        //   title: Text("啊哈哈哈哈"),
                        // );
                        ...
                        //在这里判断每个cell的不同样式
                        return _buildCell(
                            _cfanUserpostsItemModelList[index], index);
                      },
                    ),
                    //固定cell高度的写法
  ...
  _buildCell(CfanUserpostsItemModel itemModel, int index) {
    //是否已经点赞
